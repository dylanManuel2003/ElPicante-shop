...
const Sun = ({ height, width, color }: { height: string, width: string, color: string }) => {
    return (
        <svg
            height={height}
            width={width}
            ...
            <path d="M21,13H20a1,1,0,0,1,0-2h1a1,1,0,0,1,0,2Z" fill={color} />
            <path d="M4,13H3a1,1,0,0,1,0-2H4a1,1,0,0,1,0,2Z" fill={color} />
            <path
