...
const Hero = () => {
    return (
        <section className="h-screen w-full flex items-center justify-center">
            <div className="relative w-full sm:w-[90%] lg:w-[80%] h-[80%] lg:h-[60%] bg-[#510C6E] rounded-lg overflow-hidden">
                ...
                <div className="absolute inset-0 z-10 w-full lg:w-[80%] flex flex-col items-center justify-center mx-auto ">
                    <h2 className="text-shadow-sm text-[#ededed] text-[60px] mb-4 font-bold drop-shadow-black drop-shadow-2xl">Que bueno verte,<br /> buscas algo en especifico?</h2>
