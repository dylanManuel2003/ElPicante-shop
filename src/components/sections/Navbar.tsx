...
const Navbar = () => {
    ...
    return (
        <nav ref={ref} className="fixed left-0 top-0 z-50 w-full h-[80px] px-4 sm:px-16 flex justify-center items-center bg-light-secondary dark:bg-dark-secondary shadow-lg ">
            <div className="w-[90%] mx-auto flex justify-between items-center">
                ...
                <ul className={`fixed top-[80px] left-0 w-full bg-light dark:bg-dark sm:flex sm:static sm:w-auto sm:bg-transparent sm:dark:bg-transparent sm:flex-row sm:items-center sm:justify-end ${isOpen ? 'block' : 'hidden'}`}>
