...
const page = () => {
  return (
    <section className="bg-white dark:bg-dark h-full w-full">
    <div className="bg-white dark:bg-dark shadow-sm sticky top-0">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-1 md:py-4">
        <div className="flex items-center justify-between">
          <Link href="/" className="font-bold text-black dark:text-white text-2xl">Galactic Clothes</Link>
          <div className="flex items-center space-x-4">
            ...
            <button type="button" className="hidden md:block w-10 h-10 rounded-lg bg-gray-100 border border-gray-200 lg:flex justify-center items-center">
    ...
    <div className="py-6 min-h-screen h-auto">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center space-x-2 text-gray-400 text-sm">
          ...
          <a href="#" className="hover:underline hover:text-gray-600">Indumentaria</a>
          <span>
            <svg className="h-5 w-5 leading-none text-gray-300" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
              <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7" />
            </svg>
