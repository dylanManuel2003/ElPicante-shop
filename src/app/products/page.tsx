...
export default function Page() {
    return (
        <section className="h-screen w-full bg-white dark:bg-dark">
            <Navbar />
            <div className="w-full h-full mt-[80px]">
                <div className="flex justify-between">
                    <aside className="bg-light-secondary dark:bg-dark-secondary space-y-3 lg:w-1/5 lg:px-2 lg:space-y-4">
